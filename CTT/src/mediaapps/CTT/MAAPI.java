...
public class MAAPI 
{
	...
	{
		int money = Main.points.get(p.getName());
		if(p.hasPermission("lilypad.double"))
			Main.econ.depositPlayer(p.getName(), (money * 2));
		else if(p.hasPermission("lilypad.triple"))
			Main.econ.depositPlayer(p.getName(), (money * 3));
		else if(p.hasPermission("lilypad.quad"))
			Main.econ.depositPlayer(p.getName(), (money * 4));
		else if(p.hasPermission("lilypad.quint"))
			Main.econ.depositPlayer(p.getName(), (money * 5));
		else
